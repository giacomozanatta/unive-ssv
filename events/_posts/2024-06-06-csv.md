...
<div class="div-img-table">
  <div class="div-img-table-row">
    <img class="div-img-table-col" src="{{ site.baseurl }}/images/csv24-1.jpeg"/>
    <img class="div-img-table-col" src="{{ site.baseurl }}/images/csv24-2.jpeg"/>
    <img class="div-img-table-col" src="{{ site.baseurl }}/images/csv24-3.jpg"/> 
  </div>
</div>
